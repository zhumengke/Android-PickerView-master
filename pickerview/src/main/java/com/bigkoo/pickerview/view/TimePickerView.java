...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initWheelTime(LinearLayout timePickerView) {
        ...
        setTime();
        if (mPickerOptions.isShowDayofWeek) {
            wheelTime.setLabels(mPickerOptions.label_year, mPickerOptions.label_month, mPickerOptions.label_day
                    , mPickerOptions.label_hours, mPickerOptions.label_minutes, mPickerOptions.label_seconds, getWeekofDay(Calendar.getInstance()));
        } else {
            wheelTime.setLabels(mPickerOptions.label_year, mPickerOptions.label_month, mPickerOptions.label_day
    ...
    private void setTime() {
        ...
        if (mPickerOptions.isShowDayofWeek) {
            wheelTime.setPicker(year, month, day, hours, minute, seconds, getWeekofDay(calendar));
        } else {
            wheelTime.setPicker(year, month, day, hours, minute, seconds);
        }
    }

    private String getWeekofDay(Calendar calendar) {
        String zj = "";
        ...
        Log.d("calendar", calendar.get(Calendar.DAY_OF_WEEK) + "打印");
        return zj;
    }
