...
public class WheelTime {
    ...
    public void setPicker(int year, final int month, int day, int h, int m, int s,String weekofday) {
        if (isLunarCalendar) {
            int[] lunar = LunarCalendar.solarToLunar(year, month + 1, day);
            setLunar(lunar[0], lunar[1] - 1, lunar[2], lunar[3] == 1, h, m, s,weekofday);
        } else {
            setSolar(year, month, day, h, m, s,weekofday);
        }
    }
    /**
     * 设置农历
     ...
     * @param s
     */
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s,String weekofday) {
        // 年
     ...
     * @param s
     */
    private void setSolar(int year, final int month, int day, int h, int m, int s,String weekofday) {
...
//                maxItem = endD;
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds,String dayofWeek) {
        if (isLunarCalendar) {
            return;
        }
